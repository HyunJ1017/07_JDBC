...
public class JDBCExample5 {
	public static void main(String[] args) {
		 ...
		 * - SQL 중간에 ?(placehilder)를 작성하여
		 * 	? 자리에 자바 값을 대입할 준비가 되어있는 Statement
		 * 
		 * - 장점 1) SQL 작성이 간단해짐
		 * - 장점 2) ?에 값 대입시 자료형에 맞는 형태의 리터럴 표기법으로 대입
		 * 		ex) String 대입 -> '값'	(자동으로 '' 추가)
		 * 			int 대입    -> '값
		 * - 장점 3) 성능, 속도에서 우위를 가지고 잇음
		 * 
		...
		try {
			...
			//  -> 왜? 미리? placeholder에 값을 받을 준비를 해야되기 때문에
